    ...
    if block_idx == 0:
        ...
        if req_idx == num_reqs - 1:
            ...
            for i in range(q_pad_start, max_num_tokens, BLOCK_SIZE):
                ...
                # PATCH(gb10-dspark-cg): also pad input_ids rows — replayed
                # graphs read anchor ids from these rows for padded requests;
                # stale ids from earlier (larger) steps otherwise flow into the
                # Markov embedding gather. A valid constant keeps gathers in-range.
